                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 m-auto text-center">
                            <!--<a href="index.php"><img src="images/logo-img.png" style="width:350px;" /></a>-->
                            <!-- <h1 class="text-center">Hemkund PUBLIC SCHOOL</h1> -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="number" name="student_adhar" class="form-control" value="" placeholder="Student Adhar No" required>
                                    </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <label class="label">Mother Photo</label>
                                        <input type="file" name="mother_image" class="form-control">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="label">Father Photo</label>
                                        <input type="file" name="father_image" class="form-control">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="label">Guardian Photo</label>
