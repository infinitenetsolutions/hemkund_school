                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                  <a href="#"> <img class="img-fluid" src="hemkund_school/img/press/<?php echo $row['image']; ?>" alt="image" style="width: 100%;    height: 270px;"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="campus" data-rel="prettyPhoto" href="hemkund_school/img/press/<?php echo $row['image']; ?>">
