...
<head>
	...
	<title>Srinath School Portal |Admin Manage Testimonial</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="add_testimonial_test.php" class="btn btn-info">Add New Details</a>
...
{				?>	
										<tr>
											...
											<td><a href="edit_testimonial_test.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
