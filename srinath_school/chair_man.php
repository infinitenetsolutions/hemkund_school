...
$msg=$_POST['msg'];	
$sql="update chair set heading=:heading,msg=:msg";
...
<head>
	...
	<title>Srinath School Portal | Admin Update Chairman's Message</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Update Chairman's Message</h2>
