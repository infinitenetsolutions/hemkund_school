...
$sql="INSERT INTO infrastructure(msg, image, description) VALUES(:msg, :image, :description)";
...
<head>
	...
	<title>Hemkund School Portal | Admin Add Infrastructure Details</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Infrastructure Details</h2>
...
<textarea class="form-control" name="description" id="description" required cols="10" rows="10"></textarea>
</div>
</div>
</div>
