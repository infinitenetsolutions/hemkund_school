			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="add_staff.php" class="btn btn-info">Add New Teacher</a>
...
{				?>	
										<tr>
											...
											<td><a href="edit_staff_new.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
												<a href="staff.php?id=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
