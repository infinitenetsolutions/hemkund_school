...
div#block-hd {
   ...
   <!-- page-title -->
        <div class="">
            ...
            <img src="./images/single_page/photos.jpg" style="width:100%"/>
                    ...
                    <div class="col-lg-12">
                        <div class="ttm-tabs">
                            ...
                            <div class="content-tab">
                                ...
                                <?php
      $sql = mysqli_query($conn, "SELECT * FROM `gallery` group by img_desc");
      $ctr=1;
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 campus">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio">
                                               <div class="container1">
  												<a href="gallery_year.php?event=<?php echo $row['img_desc'] ?>">
                                                <img src="hemkund_school/img/vehicleimages/<?php echo $row['image']; ?>" alt="Avatar" class="image1" alt="image" style="width: 100%;height: 270px;">
                                                <div class="overlay1">
                                       ...
                                       <!-- <div id="block-hd"><a href="event_year.php?year=<?php echo $row['img_desc'] ?>"  style="color: white"><?php echo $row['img_desc'] ?></a></div>-->
                                    </div>
