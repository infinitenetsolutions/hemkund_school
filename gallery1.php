                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="current">School Gallery</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-sm-10 m-auto text-center">
                        ...
                        <div class="section-title title-style-center_text">
                            <div class="title-header">
                                <h2 class="title">Gallery Picture</h2>
                            </div>
      ...
      ?>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 campus">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio">
           								...
           								<a href="#"> <img class="img-fluid" src="hemkund_school/img/vehicleimages/<?php echo $row['image']; ?>" alt="image" style="width: 100%;height: 270px;"></a>
