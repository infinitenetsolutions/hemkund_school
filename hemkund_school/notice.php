...
<head>
	...
	<title>Hemkund School Portal |Admin Manage Notice   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="add_notice.php" class="btn btn-info">Add New Details</a>
...
{				?>	
										<tr>
											...
											<td><a href="update_notice.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
