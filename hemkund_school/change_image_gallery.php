...
<head>
	...
	<title>Hemkund Public School | Admin Update Image</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Update Image Gallery</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading" style="background: #d66431!important;color: #fff;">Edit Gallery Details</div>
...
{	?>
<div class="col-sm-8">
<img src="img/vehicleimages/<?php echo htmlentities($result->image);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
