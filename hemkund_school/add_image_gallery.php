...
if(isset($_POST['submit']))
{
 ...
 foreach($_FILES['img']['name'] as $key=>$val){        
 	...
 	$upload_file =$upload_dir.$rand.$_FILES['img']['name'][$key];
 	$filename = $rand.$_FILES['img']['name'][$key];
    //var_dump($upload_file);
  	//exit();
 	if(move_uploaded_file($_FILES['img']['tmp_name'][$key],$upload_file)){
 		$uploaded_images[] = $upload_file;
 		 $insert_sql = "INSERT INTO `gallery`(`image_year`,`image`,`img_desc`) VALUES ('$year','$filename','$event')";
