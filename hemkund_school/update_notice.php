...
if($image_temp != "")
{
    ...
    $c_update="update notice set heading='$heading', desi='$description', image='$image' where id='$id'";   
}
// else if($image_temp != "" && $msg == "")
// {
//     move_uploaded_file($image_temp , "img/vehicleimages/$image");
//     $c_update="update notice set description='$description', image= '$image' where id='$id'";   
// }
// else if($image_temp == "" && $msg != "")
// {
//      $c_update="update notice set description='$description', msg='$msg' where id='$id'";   
// }
else
{
    $c_update="update notice set heading='$heading', desi='$description' where id='$id'";
}
...
<head>
	...
	<title>Hemkund Public School | Admin Notice Updation </title>   
...
<form action="" method="post" enctype="multipart/form-data"  >
     <table width="500px" align="center" bgcolor="blueskay">
        <tr align="center">
           <td colspan="4"><h2>Update Notice Details</h2></td>
        </tr>
        <tr>
            <td align="right">Heading:</td>
            <td><input type="text" name="heading" value="<?php echo $row['heading']; ?>"  /></td>
        </tr>
        
        <tr>
            <td align="right">Description:</td>
            <td><textarea rows="4" cols="50" name="msg"><?php echo $row['desi']; ?></textarea></td>
        </tr>
