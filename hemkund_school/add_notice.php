...
$sql="INSERT INTO `notice`(heading,desi,image) VALUES (:heading, :desi, :image)";
...
<head>
	...
	<title>Hemkund School Portal | Admin Create Details</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Details</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="desi" id="desi" required>
												</div>
											</div>
