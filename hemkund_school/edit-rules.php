...
$desi=$_POST['desi'];
$id=$_GET['id'];
$sql="update aboutus set heading=:heading, desi=:desi where id=:id";
...
$msg="Details updted successfully";
...
<?php	
$id=$_GET['id'];
$ret="select * from aboutus where id=:id";
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->heading);?>" name="heading" id="brand" required>
												</div>
											</div>
                                            <div class="form-group">
